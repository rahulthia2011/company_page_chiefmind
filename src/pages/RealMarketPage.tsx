  ...
  return (
    <section className="page-panel" aria-labelledby="real-market-title">
      ...
      <p className="lead page-lead market-description">
        Chiefmind™ REAL - Market reads shipping data, import and export activity, and supplier data from multiple sources to understand how the companies you invest in actually operate. It turns that operational context into clearer signals for better investment decisions.
      </p>
      <div className="market-flow" aria-label="Market intelligence data sources">
        <div className="market-source-panel">
          <div className="market-source-window">
            <div className="market-source-track">
              ...
              <div className="market-source-layer">
                <span className="market-source-name">Decision Support</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="market-intelligence-cluster">
          <div className="market-intelligence-box">
            ...
            <span className="market-intelligence-note">Full Operating view and insights</span>
          </div>
        </div>
      </div>
    </section>
